...
namespace PatogluComposedShape
{
	...
	void ComposedShape::draw(std::ofstream &inputFile) 
	{
		...
		if(oRiR)
		{
			...
			inputFile << fileWriter;
			inputFile << '\n';
			for(auto i = 0 ; i < shapesConnected.size() ; ++i)
			{
				inputFile << shapesConnected[i];
		...
		else if(oTiT)
		{
			...
			for(auto i = 0 ; i < shapesConnected.size() ; ++i) //drawing vector of triangles.
			{
				inputFile << shapesConnected[i];
				//shapesConnected[i].draw(inputFile); //drawing vector of rectangles.
				inputFile << "\n";
		...
		else if(oTiR)
		{
			...
			inputFile << "\n";
	 		...
	 		for(auto i = 0 ; i <shapesConnected.size(); ++i) //drawing vector of rectangles.
			{
				inputFile << shapesConnected[i];
				//shapesConnected[i].draw(inputFile); //drawing vector of rectangles.
				inputFile << "\n";
